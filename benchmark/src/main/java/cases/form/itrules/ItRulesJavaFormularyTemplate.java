...
public class ItRulesJavaFormularyTemplate extends Template {
	...
	public List<Rule> ruleSet() {
		...
		rules.add(rule().condition(trigger("getset")).output(literal("public ")).output(placeholder("type")).output(literal(" get")).output(placeholder("name", "FirstUpperCase")).output(literal("() {\n\treturn ")).output(placeholder("name")).output(literal(";\n}\npublic void set")).output(placeholder("name", "FirstUpperCase")).output(literal("(")).output(placeholder("type")).output(literal(" value) {\n\tthis.")).output(placeholder("name")).output(literal(" = value;\n}")));
